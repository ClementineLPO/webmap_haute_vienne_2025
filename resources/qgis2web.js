...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [56231.717503, 5684550.825503, 279372.128106, 5847619.004218], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([56231.717503, 5684550.825503, 279372.128106, 5847619.004218], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Enquête Hirondelles 2025 - Choix des mailles à prospecter en Haute-Vienne</h2>';
        return titleElement;
    })(),
